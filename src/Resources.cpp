...
bool Sexy::ExtractLoadingImagesResources(ResourceManager* theManager)
{
	...
	try
	{
		// Optional GOTY-only resources. Retail 1.0 (and therefore PvZ 95) does
		// not contain achievements, quick play, or Zombatar assets.
		IMAGE_ACHEESEMENTS_BACK_HIGHLIGHT = aMgr.GetImage("IMAGE_ACHEESEMENTS_BACK_HIGHLIGHT");
		IMAGE_ACHEESEMENTS_BEJEWELED = aMgr.GetImage("IMAGE_ACHEESEMENTS_BEJEWELED");
		IMAGE_ACHEESEMENTS_BOOKWORM = aMgr.GetImage("IMAGE_ACHEESEMENTS_BOOKWORM");
		IMAGE_ACHEESEMENTS_CHINA = aMgr.GetImage("IMAGE_ACHEESEMENTS_CHINA");
		IMAGE_ACHEESEMENTS_CHUZZLE = aMgr.GetImage("IMAGE_ACHEESEMENTS_CHUZZLE");
		IMAGE_ACHEESEMENTS_HOLE_TILE = aMgr.GetImage("IMAGE_ACHEESEMENTS_HOLE_TILE");
		IMAGE_ACHEESEMENTS_ICONS = aMgr.GetImage("IMAGE_ACHEESEMENTS_ICONS");
		IMAGE_ACHEESEMENTS_MORE_BUTTON = aMgr.GetImage("IMAGE_ACHEESEMENTS_MORE_BUTTON");
		IMAGE_ACHEESEMENTS_MORE_BUTTON_HIGHLIGHT = aMgr.GetImage("IMAGE_ACHEESEMENTS_MORE_BUTTON_HIGHLIGHT");
		IMAGE_ACHEESEMENTS_MORE_ROCK = aMgr.GetImage("IMAGE_ACHEESEMENTS_MORE_ROCK");
		IMAGE_ACHEESEMENTS_PEGGLE = aMgr.GetImage("IMAGE_ACHEESEMENTS_PEGGLE");
		IMAGE_ACHEESEMENTS_PIPE = aMgr.GetImage("IMAGE_ACHEESEMENTS_PIPE");
		IMAGE_ACHEESEMENTS_TOP_BUTTON = aMgr.GetImage("IMAGE_ACHEESEMENTS_TOP_BUTTON");
		IMAGE_ACHEESEMENTS_TOP_BUTTON_HIGHLIGHT = aMgr.GetImage("IMAGE_ACHEESEMENTS_TOP_BUTTON_HIGHLIGHT");
		IMAGE_ACHEESEMENTS_ZUMA = aMgr.GetImage("IMAGE_ACHEESEMENTS_ZUMA");
		...
		IMAGE_REANIM_SELECTORSCREEN_WOODSIGN3_PRESS = aMgr.GetImage("IMAGE_REANIM_SELECTORSCREEN_WOODSIGN3_PRESS");
		...
		IMAGE_REANIM_ZOMBIE_BACKUP_INNERARM_HAND = aMgr.GetImage("IMAGE_REANIM_ZOMBIE_BACKUP_INNERARM_HAND");
		IMAGE_REANIM_ZOMBIE_BACKUP_OUTERARM_UPPER2 = aMgr.GetImage("IMAGE_REANIM_ZOMBIE_BACKUP_OUTERARM_UPPER2");
		...
		IMAGE_REANIM_ZOMBIE_DISCO_OUTERARM_HAND = aMgr.GetImage("IMAGE_REANIM_ZOMBIE_DISCO_OUTERARM_HAND");
		IMAGE_REANIM_ZOMBIE_DISCO_OUTERARM_UPPER2 = aMgr.GetImage("IMAGE_REANIM_ZOMBIE_DISCO_OUTERARM_UPPER2");
		...
		IMAGE_SELECTORSCREEN_ACHIEVEMENTS_BG = aMgr.GetImage("IMAGE_SELECTORSCREEN_ACHIEVEMENTS_BG");
		IMAGE_SELECTORSCREEN_ACHIEVEMENTS_PEDESTAL = aMgr.GetImage("IMAGE_SELECTORSCREEN_ACHIEVEMENTS_PEDESTAL");
		IMAGE_SELECTORSCREEN_ACHIEVEMENTS_PEDESTAL_PRESS = aMgr.GetImage("IMAGE_SELECTORSCREEN_ACHIEVEMENTS_PEDESTAL_PRESS");
...
bool Sexy::ExtractLoadingSoundsResources(ResourceManager* theManager)
{
	...
	try
	{
		SOUND_ACHIEVEMENT = aMgr.GetSound("SOUND_ACHIEVEMENT");
